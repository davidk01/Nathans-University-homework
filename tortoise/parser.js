  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_comparative() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, l, op, r) {return {tag:op, left:l, right:r};})(pos0, result0[0], result0[2], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_statement() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, v, body) {return {tag:"define", name:v,args:[], body:body};})(pos0, result0[2], result0[8]);
            }
            if (result0 === null) {
              pos = pos0;
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, v, args, body) {return {tag:"define", name:v, args:args, body:body};})(pos0, result0[2], result0[5], result0[10]);
              }
              if (result0 === null) {
                pos = pos0;
              }
      ...
      function parse_comma_ident() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, ident) {return ident;})(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, v, args) {return {tag:"call", name:v, args:args};})(pos0, result0[0], result0[2]);
              }
              if (result0 === null) {
                pos = pos0;
              }
      ...
      function parse_number_frac() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, nums) {return "." + nums.join('');})(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, nums, frac) {return parseFloat(sign + nums.join('') + frac);})(pos0, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
